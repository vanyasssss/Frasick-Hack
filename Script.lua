...
-- Создать окно UI
local Window = Library.CreateLib("Frasick hack", "RJTheme5")
...
-- Заголовок
Section:NewLabel("t.me/ssssofts")
...
-- Кнопка
Section:NewButton("silent aimbot", "aim", function()
...
-- Кнопка
Section:NewButton("tracers", "tracers", function()
...
-- Секция
local Tab = Window:NewTab("Cart Ride")
...
-- Кнопка
Section:NewButton("invisible fling", "fling", function()
        spawn(function()
...
-- Кнопка
Section:NewButton("anti fling", "antifling", function()
      -- // Constants \\ --
-- [ Services ] --
...
-- Кнопка
Section:NewButton("walk on walls", "spiderman", function()
      --BROUGHT TO YOU BY RSCRIPTS.NET!--
...
-- Кнопка
Section:NewButton("FE Yeet,fling(R6)", "FE Yeet/Fling GUI (R6)", function()
      --frasick
...
-- Кнопка
Section:NewButton("Emotes r15", "emotes r15", function()
...
-- Слайдер
Section:NewSlider("SpeedHack", "Speed", 500, 0, function(s) -- 500 (Макс. значение) | 0 (Мин. значение)
...
-- Кнопка
Section:NewButton("fly", "fly player", function()
    _G.FLYING = false
...
-- Кнопка
Section:NewButton("invisible", "CLICK E", function()
--frasick hack
...
-- Кнопка
Section:NewButton("Spam Russia", "Russia top", function()
while true do wait(1) 

local A_1 = "Slava Rashe" local A_2 = "All" 
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) end
end)


-- Кнопка
Section:NewButton("Spam Urkaine", "Ukraine parasha", function()
while true do wait(1) 

local A_1 = "Ukraine parasha" local A_2 = "All" 
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) end
end)


-- Кнопка
Section:NewButton("visual headless", "not head", function()
...
-- Кнопка
Section:NewButton("gravity gun", "может тащить воздушный шар", function()
...
Section:NewButton("respawn", "respawn", function()
...
for i = 1,1 do
local A_1 = "script--->t.me/ssssofts" local A_2 = "All" 
local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) end
